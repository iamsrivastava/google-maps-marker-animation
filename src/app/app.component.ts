...
export class AppComponent {
  ...
  marker;
  position = {lat: 8.893260000000001, lng: 76.61427};
  numDeltas = 10;
  delay = 10;
  index = 0;
  route: any;
  ...
  transition(oldPosition, newPosition) {
    const i = 0;
  ...
  moveMarker(i: any, deltaLat, deltaLng) {
  ...
  test() {
    if (this.index < this.pathCords.length) {
      this.transition(this.position, this.pathCords[this.index]);
    }
  }
}
